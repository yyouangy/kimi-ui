<template>
  <div class="k-tabs">
    <div class="k-tabs-nav" ref="container">
      <div :class="{ selected: t === selected }" class="k-tabs-nav-item" v-for="(t, index) in titles" :ref="
          (el) => {
    ...
    <div class="k-tabs-content">
      <component class="k-tabs-content-item" v-for="(c, index) in defaults" :key="index" :is="c" :class="{ selected: c.props.title === selected }"></component>
    </div>
  </div>
</template>
